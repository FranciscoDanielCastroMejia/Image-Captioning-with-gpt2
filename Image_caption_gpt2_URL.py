...
Image_URL = "https://encrypted-tbn3.gstatic.com/images?q=tbn:ANd9GcQgByBT5IiAT_a2x9pUVb4VMoOrlzHH7Jrzj-HB5jzHlR4lNLMS"

    
       
CAPTION = get_caption(model, image_processor, tokenizer, Image_URL)
print("PREDICT CAPTION : %s" %(CAPTION))
text = CAPTION
prueba = image_classification2(text)
prueba.link = Image_URL
